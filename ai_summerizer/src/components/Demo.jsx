            ...
            <div className="my-10 max-w-full flex justify-center items-center">
                {isFetching ? (
                    ...
                    <p className="font-inter font-bold text-black text-center">
                        ...
                        <br />
                        <span className="font-normal font-serif text-gray-700">
                            {error?.data?.error}
                        </span>
                    </p>
                ) : (
                    article.summary && (
                        <div className="flex flex-col gap-3">
                            <h2 className="font-bold font-serif text-gray-600 text-xl">
                                Article{" "}
                                <span className="blue_gradient">Summary</span>
                            </h2>
                            <div className="summary_box">
                                <p className="font-inter font-medium text-sm text-gray-00">
                                    {article.summary}
                                </p>
                            </div>
                        </div>
